    ...
    <>
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          ...
          disabled={deleting}
          className="inline-flex items-center justify-center rounded-lg border border-red-300 bg-white px-5 py-2.5 text-sm font-semibold text-red-700 transition hover:bg-red-50 disabled:cursor-not-allowed disabled:opacity-50 dark:border-red-400 dark:bg-slate-900 dark:text-red-400 dark:hover:bg-red-950"
        >
